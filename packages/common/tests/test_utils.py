...
from common.utils import format_datetime, get_password_hash, is_valid_email, verify_password
...
class TestPasswordUtils:
    ...
    def test_get_password_hash(self):
        ...
        expected_hash_length = 80
        assert len(hashed) == expected_hash_length
...
class TestDateTimeUtils:
    ...
    def test_format_datetime_returns_string(self):
        ...
        expected_length = 19  # YYYY-MM-DD HH:MM:SS format
        assert len(formatted) == expected_length
